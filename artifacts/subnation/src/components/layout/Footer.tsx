...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/25 bg-background mt-12 mb-[72px] md:mb-0">
      <div className="max-w-6xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground/45">
        ...
        <div className="flex items-center gap-4">
          <Link href="/terms">
            <span className="hover:text-muted-foreground/70 transition-colors cursor-pointer">الشروط والأحكام</span>
          </Link>
          <span className="w-px h-3 bg-border/40" />
          <Link href="/terms">
            <span className="hover:text-muted-foreground/70 transition-colors cursor-pointer" onClick={() => setTimeout(() => {
          ...
          <span className="w-px h-3 bg-border/40" />
          <Link href="/support">
            <span className="hover:text-muted-foreground/70 transition-colors cursor-pointer">الدعم</span>
          </Link>
        </div>
      </div>
    </footer>
